				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading" style="background-color: #3e3e40; color:white;">Warehouse Integration IMS to SAP</div>
							...
							<div class="row">
								<div class="col-md-12 form-inline">
									<div class="alert alert-danger" id="del_msg">
										...
										&nbsp;&nbsp;<button class="btn btn-success del" type="submit"><?php echo anchor('main/warehouse_integration_delete/'.$this->uri->segment(3), 'Yes'); ?></button>
							...
							<button class="btn btn-info"><span class="glyphicon glyphicon-plus-sign"></span>&nbsp;&nbsp;<?php echo anchor('main/warehouse_integration_create', 'Add Warehouse');?></button><br><br>
									...
									<tbody>
										...
										<tr>
											...
											<td style="text-align: center;">
												...
												<?php echo anchor('main/warehouse_integration_edit/'.$r->Id,'<i class="glyphicon glyphicon-wrench"></i>
												<span class="hidden-tablet">Edit</span>', 'class="label label-warning"');?>

												<?php echo anchor('main/warehouse_integration/'.$r->Id,'<i class="glyphicon glyphicon-trash"></i>
