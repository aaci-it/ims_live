...
if(isset($wn)){
	$xls_name = "WAR_Summary_Lists_".$wn."_".$datetime.".xls";
}
	  ...
	  function fnExcelReport()
		...
		$(document).ready(function(){
			...
			$('#export_xls a').click(function(){
				$('#tft').remove();
				return ExcellentExport.excel(this, 'myTable', 'WAR_Summary_Lists');
			});
	    ...
	    <div class="row">
	        <div class='col-sm-12'>
	        	<div class="panel panel-default">
	        		<div class="panel-heading" style="background-color: #3e3e40; color:white;"><strong>WAR Summary Lists</strong></div>
	        		<div class="panel-body form-inline" id="pbody">
							...
							<?php if(isset($total_war)): foreach($total_war as $twr): ?>

								<button class="btn btn-primary" type="button">
									<strong>Total Item's Qty</strong> <span class="badge"><?php echo number_format($twr->wi_itemqty, 2) ?></span>
								</button>&nbsp;&nbsp;
