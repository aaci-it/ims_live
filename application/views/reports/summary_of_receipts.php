...
if(isset($wn)){
	$xls_name = "Summary_Of_Receipts_".$wn."_".$datetime.".xls";
}
	  ...
	  function fnExcelReport()
		...
		$(document).ready(function(){
			...
			$('#export_xls a').click(function(){
				$('#tft').remove();
				return ExcellentExport.excel(this, 'myTable', 'Summary_Of_Receipts');
			});
	    ...
	    <div class="row">
	        <div class='col-sm-12'>
	        	<div class="panel panel-default">
	        		<div class="panel-heading" style="background-color: #3e3e40; color:white;"><strong>Summary of Receipts</strong></div>
	        			...
	        			<div class="row">
	        				<div class="col-md-12">
	        					<div class="well">
									...
									<?php if(isset($total_sor)): foreach($total_sor as $tsr): ?>

										<button class="btn btn-primary" type="button">
											<strong>Total Item's Qty</strong> <span class="badge"><?php echo number_format($tsr->wi_itemqty, 2) ?></span>
										</button>&nbsp;&nbsp;
									...
									<table id="myTable">
										<thead>
											<tr>
												...
												<th>SubType</th>
												<th>Whse Code</th>
												<th>Receiving Warehouse Name</th>
												<th>Code</th>
												<th>Source</th>
										...
										<tfoot id="tft">
												<tr>
													<th colspan="27" class="ts-pager form-horizontal">
										...
										<tbody>
											<tr><?php if($summary_of_receipts): foreach ($summary_of_receipts as $r): ?>
