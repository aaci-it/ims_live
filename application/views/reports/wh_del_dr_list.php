...
if(isset($wn)){
	$xls_name = "DR_Summary_Lists_".$wn."_".$datetime.".xls";
}
	  ...
	  function fnExcelReport()
		...
		$(document).ready(function(){
			...
			$('#export_xls a').click(function(){
				$('#tft').remove();
				return ExcellentExport.excel(this, 'myTable', 'DR_Summary_Lists');
			});
	    ...
	    <div class="row">
	        <div class='col-sm-12'>
	        	<div class="panel panel-default">
	        		<div class="panel-heading" style="background-color: #3e3e40; color:white;"><strong>DR Summary Lists</strong></div>
	        		<div class="panel-body form-inline" id="pbody">
							...
							<?php if(isset($total_dr)): foreach($total_dr as $tid): ?>

								<button class="btn btn-primary" type="button">
									<strong>Total Item's Qty</strong> <span class="badge"><?php echo number_format($tid->wi_itemqty, 2) ?></span>
								</button>&nbsp;&nbsp;

								<button class="btn btn-info" type="button">
									<strong>Total DO/ITO Qty</strong> <span class="badge"><?php echo number_format($tid->wi_doqty, 2) ?></span>
								</button>&nbsp;&nbsp;

								<button class="btn btn-warning" type="button">
									<strong>Total </strong> <span class="badge"><?php echo number_format($tid->wi_doqty - $tid->wi_itemqty, 2) ?></span>
								</button>
							...
							<table id="myTable">
								...
								<tfoot id="tft">
										<tr>
											<th colspan="19" class="ts-pager form-horizontal">
								...
								<tbody>
									<tr><?php if(isset($reserverecord)): foreach ($reserverecord as $r):?>
										...
										<td><?php echo $r->trk_accepteddate; ?></td>
										<td><?php echo $r->trk_acceptedremarks; ?></td>
