	    ...
	    <div class="row">
	        <div class='col-sm-12'>
	        	<div class="panel panel-default">
	        		<div class="panel-heading" style="background-color: #3e3e40; color:white;"><strong>Unserve Lists</strong></div>
							...
							<div class="row">
		        				<div class="col-md-12">
		        					<div class="well">
										...
										<?php if(isset($total_unl)): foreach($total_unl as $tul): ?>

											<button class="btn btn-primary" type="button">
												<strong>Total Item's Qty</strong> <span class="badge"><?php echo number_format($tul->wi_itemqty, 2) ?></span>
											</button>&nbsp;&nbsp;

											<button class="btn btn-info" type="button">
												<strong>Total DO/ITO Qty</strong> <span class="badge"><?php echo number_format($tul->wi_doqty, 2) ?></span>
											</button>&nbsp;&nbsp;

											<button class="btn btn-warning" type="button">
												<strong>Total Remaining Qty</strong> <span class="badge"><?php echo number_format($tul->wi_doqty - $tul->wi_itemqty , 2) ?></span>
											</button>
								...
								<tbody>
									<tr><?php if(isset($reserverecord)): foreach ($reserverecord as $r):?>
										...
										<?php  
											...
											$doqty_temp = $r->wi_doqty - $r->wi_itemqty;
										...
										<td><?php echo number_format($r->wi_doqty,2);?></td>
										<td><?php echo number_format($r->wi_itemqty,2);?></td>
										<td><?php echo number_format($r->wi_doqty - $r->wi_itemqty,2);?></td>
