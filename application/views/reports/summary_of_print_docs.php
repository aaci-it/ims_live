				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading" style="background-color: #3e3e40; color:white;">Summary of Print Documents</div>
							...
							<div class="row">
								<div class="col-md-12 form-inline">
									<div class="alert alert-danger" id="del_msg">
										...
										&nbsp;&nbsp;<button class="btn btn-success del" type="submit"><?php echo anchor('main/delete_dr_pdf/'.$this->uri->segment(3), 'Yes'); ?></button>
							...
							<div class="row">
								...
								<div class="col-md-4">
									...
									<?php $dtype_list = array('DR'=>'DR', 'WIS'=>'WIS', 'RR'=>'RR', 'TIN'=>'TIN', 'TOUT'=>'TOUT'); ?>
	        						<?php echo form_dropdown('dtype',$dtype_list, $this->input->post('dtype'));?><br>
								</div>
							...
							<div class="table-responsive">
								<table id="myTable">
									...
									<tbody>
										...
										<tr>
											<td><?php echo $r->whse_id;?></td>
											<td><?php echo $r->doc_type?></td>
											<td><?php echo $r->whse_name;?></td>
											<td><?php echo $r->print_datetime; ?></td>
											<td><?php echo $r->print_by; ?></td>

<!-- 											<td style="text-align: center;">

												<?php echo anchor('main/open_dr_pdf/'.$r->whse_id,'<i class="glyphicon glyphicon-print"></i>
												<span class="hidden-tablet">Print</span>', 'class="label label-success"');?>

												<?php echo anchor('main/print_dr_list/'.$r->whse_id,'<i class="glyphicon glyphicon-trash"></i>
