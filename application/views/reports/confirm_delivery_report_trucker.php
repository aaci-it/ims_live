...
<?php
	...
	$trucker = array('name'=>'trucker', 'value'=>$this->input->post('trucker'));

	date_default_timezone_set("Asia/Manila");
	$datetime = date('Y-m-d');

	$xls_name = "Confirmation_Delivery_Report_Transporter_".$datetime.".xls";
	    ...
	    <div class="row">
	        <div class='col-sm-12'>
	        	<div class="panel panel-default">
	        		<div class="panel-heading" style="background-color: #3e3e40; color:white;"><strong>Delivery Confirmation Report - Transporter</strong></div>
	        		<div class="panel-body form-inline"  id="pbody">
	        			<div class="col-md-4">
							...
							<?php if($rcd->memb_comp == 'AACI'): ?>
	        					...
	        					<?php echo form_input($trucker); ?><br/><br/>
									...
									<tr><?php if($records): foreach ($records as $r): ?>
										...
										<td>
											<?php 
												...
												$atime_src = $r->truck_arrival_time;
												$atime_src = substr($atime_src, 0, -3);

												if($atime_src[0]=='0'){
													$time1 = substr($atime_src, -4, 1);
												}else{
													$time1 = substr($atime_src, 0, 2);
												}
												...
												if($atime_src=="00:00"){
													...
													if($time2 >=12 and $time2 <=23){
														$atime_src = $atime_src." PM";
													}else{
														$atime_src = $atime_src." AM";
													}
												}
