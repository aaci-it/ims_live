...
if(isset($wn)){
	$xls_name = "Cancel_DO_Lists_".$wn."_".$datetime.".xls";
}
	  ...
	  function fnExcelReport()
		...
		$(document).ready(function(){
			...
			$('#export_xls a').click(function(){
				$('#tft').remove();
				return ExcellentExport.excel(this, 'myTable', 'Cancel_DO_Lists');
			});
	    ...
	    <div class="row">
	        <div class='col-sm-12'>
	        	<div class="panel panel-default">
	        		<div class="panel-heading" style="background-color: #3e3e40; color:white;"><strong>Cancelled DO Lists</strong></div>
	        		<div class="panel-body form-inline" id="pbody">
							...
							<?php if(isset($total_can)): foreach($total_can as $tcl): ?>

								<button class="btn btn-primary" type="button">
									<strong>Total Item's Qty</strong> <span class="badge"><?php echo number_format($tcl->wi_itemqty, 2) ?></span>
								</button>&nbsp;&nbsp;

								<button class="btn btn-info" type="button">
									<strong>Total DO/ITO Qty</strong> <span class="badge"><?php echo number_format($tcl->wi_doqty, 2) ?></span>
								</button>
							...
							<table id="myTable">
								...
								<tbody>
									<tr><?php if(isset($reserverecord)): foreach ($reserverecord as $r):?>
										...
										<td><?php echo $r->wi_cancelremarks;?></td>
										<td><?php echo $r->wi_cancelby;?></td>
										<td><?php echo $r->wi_canceldatetime;?></td>
