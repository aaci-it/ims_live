...
<?php
	...
	$xls_name = "Confirmation_Delivery_Report_".$datetime.".xls";
	    ...
	    <div class="row">
	        <div class='col-sm-12'>
	        	<div class="panel panel-default">
	        		<div class="panel-heading" style="background-color: #3e3e40; color:white;"><strong>Delivery Confirmation Report</strong></div>
	        		<div class="panel-body form-inline" id="pbody">
	        			...
	        			<div class="col-md-4">
							...
							<input type="submit" name="Search" value="Search" class="btn btn-info" id="search"/>
