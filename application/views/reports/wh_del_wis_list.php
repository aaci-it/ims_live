...
<?php 
$sdate = array('name'=>'sdate','value'=>$this->input->post('sdate'),'id'=>'datepicker', 'data-format'=>'yyyy-MM-dd');
$edate = array('name'=>'edate','value'=>$this->input->post('edate'),'id'=>'datepicker1', 'data-format'=>'yyyy-MM-dd');

date_default_timezone_set("Asia/Manila");
$datetime = date('Y-m-d');

if(isset($wn)){
	$xls_name = "WIS_Summary_Lists_".$wn."_".$datetime.".xls";
}
	   ...
	   function fnExcelReport()
		...
		$(document).ready(function(){
			...
			$('#export_xls a').click(function(){
				$('#tft').remove();
				return ExcellentExport.excel(this, 'myTable', 'WIS_Summary_Lists');
			});
	    ...
	    <div class="row">
	        <div class='col-sm-12'>
	        	<div class="panel panel-default">
	        		<div class="panel-heading" style="background-color: #3e3e40; color:white;"><strong>WIS Summary Lists</strong></div>
	        		<div class="panel-body form-inline" id="pbody">
							...
							<?php if(isset($total_wis)): foreach($total_wis as $tws): ?>

								<button class="btn btn-primary" type="button">
									<strong>Total Item's Qty</strong> <span class="badge"><?php echo number_format($tws->wi_itemqty, 2) ?></span>
								</button>&nbsp;&nbsp;
