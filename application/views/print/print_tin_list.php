				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading" style="background-color: #3e3e40; color:white;">Transfer In Print Lists</div>
							...
							<div class="row">
								<div class="col-md-12 form-inline">
									<div class="alert alert-danger" id="del_msg">
										...
										&nbsp;&nbsp;<button class="btn btn-success del" type="submit"><?php echo anchor('main/delete_tin_pdf/'.$this->uri->segment(3), 'Yes'); ?></button>
									...
									<tbody>
										...
										<tr>
											...
											<td style="text-align: center;">
												...
												<?php echo anchor('main/open_tin_pdf/'.$r->wi_id,'<i class="glyphicon glyphicon-print"></i>
