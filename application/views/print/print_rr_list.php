				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading" style="background-color: #3e3e40; color:white;">Receiving Report Print Lists</div>
							...
							<div class="row">
								<div class="col-md-12 form-inline">
									<div class="alert alert-danger" id="del_msg">
										...
										&nbsp;&nbsp;<button class="btn btn-success del" type="submit"><?php echo anchor('main/delete_rr_pdf/'.$this->uri->segment(3), 'Yes'); ?></button>
									...
									<tbody>
										...
										<tr>
											...
											<td style="text-align: center;">
												...
												<?php echo anchor('main/open_rr_pdf/'.$r->wi_id,'<i class="glyphicon glyphicon-print"></i>
												<span class="hidden-tablet">Print</span>', 'class="label label-success"');?>

												<?php echo anchor('main/print_rr_list/'.$r->wi_id,'<i class="glyphicon glyphicon-trash"></i>
