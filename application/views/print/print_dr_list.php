				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading" style="background-color: #3e3e40; color:white;">Delivery Receipts Print Lists</div>
									...
									<tbody>
										...
										<tr>
											...
											<td style="text-align: center;">
												...
												<?php echo anchor('main/open_dr_pdf/'.$r->wi_id,'<i class="glyphicon glyphicon-print"></i>
												<span class="hidden-tablet">Print</span>', 'class="label label-success"');?>

												<?php echo anchor('main/print_dr_list/'.$r->wi_id,'<i class="glyphicon glyphicon-trash"></i>
