	      ...
	      <div class="navbar navbar-dark bg-primary" id="navi2" role="navigation">
	        ...
	        <div class="navbar-collapse collapse sidebar-navbar-collapse">
	          <ul class="nav navbar-nav">
	            ...
	            <li class="active"><?php echo anchor('main/standard_refined', 'Standard Refined Sugar', 'style="background: white; color: #3e3e40;"'); ?></li>
	  ...
	  <div class="col-sm-7">
	  	<div class="panel panel-default">
	  		<div class="panel-body">
	  			<div class="panel-heading" style="background-color: #337ab7; color:white;"><strong>Standard Refined Sugar</strong></div><br>
			
	  			<p style="text-align: justify;">Refined Sugar is a white sugar that has been refined and washed so that it has a white appearance and no molasses flavor.</p>
	  			<p style="text-align: justify;">Refined sugar is produced by first removing the film from raw sugar that gives it its brown color via a process called affination. The sugar is then dissolved in water, and filtered until it becomes a clear colorless liquid. The liquid is then evaporated until crystals form again.</p>
	  			<p style="text-align: justify;">These crystals are then spun in a centrifuge until sugar flows from the machine into drying drums. Heated air in the drums absorb most of the remaining moisture, leaving a pure white refined sugar</p>
	  			<p style="text-align: justify;">Standard refined sugar is the basic grade of refined sugar but still has a higher sweetness compared to raw sugar. It is used in the production of light-colored products that require a high level of sweetness, including non-alcohol beverages, juices, ice cream, pastries, condiments and sauces.</p>

			</div>
	  	</div>
	  </div>
	  <div class="col-sm-2">
	  	<img src="<?php echo base_url();?>sugar/SRS.jpg">
	  </div>
	</div>
</div>
