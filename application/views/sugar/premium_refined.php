	      ...
	      <div class="navbar navbar-dark bg-primary" id="navi2" role="navigation">
	        ...
	        <div class="navbar-collapse collapse sidebar-navbar-collapse">
	          <ul class="nav navbar-nav">
	            ...
	            <li class="active"><?php echo anchor('main/premium_refined', 'Premium Refined Sugar', 'style="background: white; color: #3e3e40;"'); ?></li>
	  ...
	  <div class="col-sm-7">
	  	<div class="panel panel-default">
	  		<div class="panel-body">
	  			<div class="panel-heading" style="background-color: #337ab7; color:white;"><strong>Premium Refined Sugar</strong></div><br>
			
	  			<p style="text-align: justify;">Premium Refined Sugar is refined sugar that has a higher clarity compared to standard refined sugar, allowing food manufacturers to preserve the natural color and integrity of a product’s basic ingredients. It is also the sweetest cane sugar, strongly complementing full-flavored foods. Granulation of premium refined sugar is also less than that of standard refined sugar.</p>
	  			<p style="text-align: justify;">Applications for premium refined sugar include juices, carbonated drinks, powdered milk, powdered juice (including iced tea), medicines, dressings, flavorings, glazes and confectioneries.</p>

			</div>
	  	</div>
	  </div>
	  <div class="col-sm-2">
	  	<img src="<?php echo base_url();?>sugar/PRS2.jpg">
	  </div>
	</div>
</div>
