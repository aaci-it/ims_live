	      ...
	      <div class="navbar navbar-dark bg-primary" id="navi2" role="navigation">
	        ...
	        <div class="navbar-collapse collapse sidebar-navbar-collapse">
	          <ul class="nav navbar-nav">
	            ...
	            <li class="active"><?php echo anchor('main/turbinado', 'Turbinado', 'style="background: white; color: #3e3e40;"'); ?></li>
	          </ul>
	        </div><!--/.nav-collapse -->
	      </div>
	    </div>
	  ...
	  <div class="col-sm-7">
	  	<div class="panel panel-default">
	  		<div class="panel-body">
	  			<div class="panel-heading" style="background-color: #337ab7; color:white;"><strong>Turbinado</strong></div><br>
			
	  			<p style="text-align: justify;">Turbinado sugar, also known as turbinated sugar, is a specialized form of raw sugar characterized by large crystals that are lighter in color and lower in moisture content than standard raw sugar.</p>
	  			<p style="text-align: justify;">Turbinado, with its mild natural flavor of molasses makes it a delightful addition to tea or coffee. Its crunch and full sweetness also make it an attractive addition to cereals, pastries and confections.</p>

			</div>
	  	</div>
	  </div>
	  <div class="col-sm-2">
	  	<img src="<?php echo base_url();?>sugar/TURBI.jpg">
	  </div>
	</div>
</div>
