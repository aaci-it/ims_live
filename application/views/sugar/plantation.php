	      ...
	      <div class="navbar navbar-dark bg-primary" id="navi2" role="navigation">
	        ...
	        <div class="navbar-collapse collapse sidebar-navbar-collapse">
	          <ul class="nav navbar-nav">
	            ...
	            <li class="active"><?php echo anchor('main/plantation', 'Plantation White Sugar', 'style="background: white; color: #3e3e40;"'); ?></li>
	  ...
	  <div class="col-sm-7">
	  	<div class="panel panel-default">
	  		<div class="panel-body">
	  			<div class="panel-heading" style="background-color: #337ab7; color:white;"><strong>Plantation White Sugar</strong></div><br>
				
				<p style="txet-align: justify;">Plantation White Sugar, also known as Blanco Directo or Crystal Sugar is a form of raw sugar whose color is almost that of refined sugar. Unlike refined sugar though, it is produced without remelting or refining raw sugar.</p>
				<p style="txet-align: justify;">Plantation Whites are made by injecting sulfur dioxide gas into cane juice, thereby bleaching the juice’s colorants. By bleaching the many impurities that give raw sugar its brown color, this sulfitation process is able to produce a nearly colorless raw sugar that can easily substitute refined sugar in many cases.</p>
				<p style="txet-align: justify;">This type of sugar is often used in cakes, pastries, condiments, sauces and beverages.</p>

			</div>
	  	</div>
	  </div>
	  <div class="col-sm-2">
	  	<img src="<?php echo base_url();?>sugar/PWS.jpg">
	  </div>
	</div>
</div>
