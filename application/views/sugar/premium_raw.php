	      ...
	      <div class="navbar navbar-dark bg-primary" id="navi2" role="navigation">
	        ...
	        <div class="navbar-collapse collapse sidebar-navbar-collapse">
	          <ul class="nav navbar-nav">
	            ...
	            <li class="active"><?php echo anchor('main/premium_raw', 'Premium Raw (Washed) Sugar', 'style="background: white; color: #3e3e40;"'); ?></li>
	  ...
	  <div class="col-sm-7">
	  	<div class="panel panel-default">
	  		<div class="panel-body">
	  			<div class="panel-heading" style="background-color: #337ab7; color:white;"><strong>Premium Raw (Washed) Sugar</strong></div><br>
				
				<p style="text-align: justify;">Premium raw (washed) sugar is a form of raw sugar that has had a larger reduction of molasses removed from its coating. It is thus a much lighter form of raw sugar. As such clients find it to be a cost-effective alternative to refined sugar.</p>
				<p style="text-align: justify;">Premium Raw (Washed) sugar is used primarily by makers of hard liquor, condiments, flavorings and glazes. It is priced at a premium to raw sugar.</p>

			</div>
	  	</div>
	  </div>
	  <div class="col-sm-2">
	  	<img src="<?php echo base_url();?>sugar/PRS.jpg">
	  </div>
	</div>
</div>
