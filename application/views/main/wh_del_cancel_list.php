				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading" style="background-color: #3e3e40; color:white;">Cancel Delivery In-Out List</div>
								...
								<table>
									...
									<tbody>
										<tr><?php if(isset($reserverecord)): foreach ($reserverecord as $r):?>
											...
											<td>Delivery In</td>
											<?php endif;?> 
											<td><?php echo anchor('main/wh_delivery_cancel/'.$r->item_id.'/'.$get.'_'.$r->wi_id,'Cancel');?> |
											<?php echo anchor('main/item_in_readonly/'.$r->wi_id,'View');?></td>
										</tr>
										<?php endforeach;?>
										<?php else:?>
									<tr>
